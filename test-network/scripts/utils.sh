...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println "    -c <channel name> - Name of channel to deploy chaincode to"
    println "    -ccn <name> - Chaincode name."
    println "    -ccf <function> - Chaincode function."
    println
    println "    -h - Print this message"
    println
    println " Possible Mode and flag combinations"
    println "   \033[0;32minvokeCC\033[0m -c -ccn -ccf"
    println
    println " Examples:"
    println "   network.sh invokeCC  -ccn basic -ccf '{\"function\":\"TransferAsset\",\"Args\":[\"asset6\",\"Christopher\"]}'"
  else
    println "Usage: "
    ...
    println "      \033[0;32minvokeCC\033[0m - Invoke The Function on channel"
